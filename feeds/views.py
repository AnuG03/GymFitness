...
from feeds.models import Contact,MembershipPlan,Trainer,Enrollment,Gallery,Attendance,Award,Service
...
def bi_tri(request):
    return render(request,"bi_tri.html")
